                ...
                <div className="flex flex-col mt-12 h-full">
                    <div className="flex flex-col items-center">
                        ...
                        <p className="font-[400] text-[14px] leading-[18px] mt-8 text-center text-gray-600 px-6 max-w-sm">
                            {result > 0 
                                ? 'Отличный результат! Вы хорошо определили первую букву слова, что говорит о развитой вербальной памяти.'
                                : 'Попробуйте ещё раз! Тренировка поможет лучше запоминать звуки и связывать их с буквами.'
                            }
                        </p>
                    </div>
                </div>
