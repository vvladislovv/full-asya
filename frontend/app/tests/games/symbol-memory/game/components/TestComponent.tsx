                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <div className="relative bg-[#E0E4E9] w-[178px] h-[178px] rounded-full p-4">
                            ...
                            <div className="bg-[#F2F5F9] w-full rounded-full h-full flex items-center justify-center">
                                <div className="flex flex-col gap-[4px] items-center">
                                    <span className="font-[500] text-[16px] leading-[16px]">{result/allSymbols.length > 0.75 ? 'Высокий уровень' : result/allSymbols.length>0.5 ? 'Средний уровень' : 'Низкий уровень'}</span>
                                    <div>
                        ...
                        <p className="font-[400] text-[14px] leading-[18px] mt-8 text-center text-gray-600 px-6 max-w-sm">
                            {result/allSymbols.length > 0.75 
                                ? 'Отличный результат! Ваша зрительная память и внимание работают очень хорошо.'
                                : result/allSymbols.length > 0.5 
                                ? 'Хороший результат! Есть потенциал для улучшения концентрации внимания.'
                                : 'Результат можно улучшить. Тренировка внимания поможет лучше запоминать символы.'
                            }
                        </p>
                    </div>
                </div>
    ...
    return (
        <div className="flex flex-col items-center justify-center h-full">
            <div className="text-[20px] font-[600] text-[#1E1E1E] mb-4">
                Карточка {currentIndex + 1} из {allSymbols.length}
            </div>
            <div className="text-[18px] font-[500] text-[#1E1E1E] mb-8 text-center px-4">
                Был ли этот символ в показанном списке?
            </div>
