...
export const CountOperationsResultComponent : React.FC<StroopTestResultComponentProps> = ({restart, result, currentTestIndex, setCurrentTestIndex, onNextTest, onBackToList}) => {
    const { t } = useLanguage();
    return (
        <div>
